...
namespace ETicaretProjesiV2._0.Application.Services
{
    public class AdminManagementService : IAdminManagementService
    {
        ...
        public async Task DeleteProductWithReasonAsync(DeleteProductDto dto)
        {
            ...
            string mailBody = $@"
                <div style='font-family: Arial, sans-serif; line-height: 1.6; color: #333;'>
                    ...
                    <p>Mağazanızda yer alan <strong>{product.Name}</strong> isimli ürün, platform kurallarımıza uymadığı gerekçesiyle kaldırılmıştır.</p>
        ...
        {
            return await _productRepo.GetAllAsQueryable(tracking: false)
        ...
        {
            return await _productRepo.Where(p => p.SellerId == userId)
                .Select(p => new AdminProductDto
                {
                    Id = p.Id,
                    Name = p.Name,
